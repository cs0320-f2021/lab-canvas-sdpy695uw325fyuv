...
$(document).ready(() => {
  ...
  // TODONE: set the width and height of canvas
  ...
  // TODONE: set up the canvas context
...
const paintToggle = () => {
  ...
  // TODONE: fill the background color of the canvas element to
  // something other than white using ctx.fillStyle() and ctx.fillRect()
  ctx.fillStyle = "#ECD589"
  ctx.fillRect(0, 0, canvas.width, canvas.height);


  // TODONE: draw the grid lines for the toggle pane using ctx.beginPath()
  // and ctx.moveTo()
